...
window=tk.Tk()
window.title("Message Reverser")#title at top of window
window.geometry("400x250") #set size(Width x height)
window.resizable(False,False) #Keep from being resized
